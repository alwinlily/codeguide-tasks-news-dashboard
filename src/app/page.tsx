...
async function getTodos() {
  try {
    const response = await fetch(`${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3006'}/api/todos`, {
      cache: 'no-store',
    });
...
async function getUrgentTodos() {
  try {
    const response = await fetch(`${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3006'}/api/urgent`, {
      cache: 'no-store',
    });
...
async function getNews() {
  try {
    const response = await fetch(`${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3006'}/api/news`, {
      cache: 'no-store',
    });
...
async function getWeather() {
  try {
    const response = await fetch(`${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3006'}/api/weather`, {
      cache: 'no-store',
    });
